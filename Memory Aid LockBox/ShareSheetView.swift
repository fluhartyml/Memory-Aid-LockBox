...
struct ShareSheetView: UIViewControllerRepresentable {
    ...
    func makeUIViewController(context: Context) -> UIActivityViewController {
        var shareItems: [Any] = [Self.summary(for: item)]
    ...
    /// A complete, human-readable text summary of the record, including whichever
    /// template fields it carries. Empty fields are skipped so the summary stays
    /// clean regardless of type.
